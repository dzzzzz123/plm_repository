package ext.sinoboom.ppmService.config;
...
public class PPMConfig {
	...
	static {
		...
		try {
			...
			tempBuf.append(sep).append("codebase").append(sep).append("ext").append(sep).append("sinoboom").append(sep)
					.append("ppmService").append(sep).append("config").append(sep).append("PPMConfig.properties");
